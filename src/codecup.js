...
class EditorJsCodeCup {
  ...
  constructor({ data, config, api, readOnly }) {
    ...
    this._placeholder = config.placeholder
      ? config.placeholder
      : EditorJsCodeCup.DEFAULT_PLACEHOLDER;
    ...
    this.data.showlinenumbers =
      data.showlinenumbers === undefined ? true : data.showlinenumbers;
    this.data.showCopyButton =
      data.showCopyButton === undefined ? true : data.showCopyButton;
  ...
  renderSettings() {
    ...
    languageEntryInput.addEventListener('keydown', (event) => {
      if (event.key === 'Enter') {
  ...
  _updateLanguage = (lang) => {
    ...
    this._element.querySelector('.editorjs-codeCup_LangDisplay').innerHTML =
      this.data.language;
